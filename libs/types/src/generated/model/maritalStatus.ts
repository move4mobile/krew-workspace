...
export type MaritalStatus = 'unknown' | 'not_married' | 'married' | 'cohabitating' | 'civil_unionship';

export const MaritalStatus = {
    Unknown: 'unknown' as MaritalStatus,
    NotMarried: 'not_married' as MaritalStatus,
    Married: 'married' as MaritalStatus,
    Cohabitating: 'cohabitating' as MaritalStatus,
    CivilUnionship: 'civil_unionship' as MaritalStatus
};
