...
export interface UpdateInstanceParameters { 
    status: UpdateInstanceParameters.StatusEnum | null;
    assignee: string | null;
    responsible_employee: string | null;
    data: string | null;
    metadata?: Array<string>;
}
export namespace UpdateInstanceParameters {
    export type StatusEnum = 'pending' | 'submitted' | 'approved';
