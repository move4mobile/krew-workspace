...
export type ContractType = 'permanent' | 'temporary' | 'loan' | 'other';

export const ContractType = {
    Permanent: 'permanent' as ContractType,
    Temporary: 'temporary' as ContractType,
    Loan: 'loan' as ContractType,
    Other: 'other' as ContractType
};
