...
export type FormInstanceSortField = 'createdAt' | 'submitDate' | 'approveDate';

export const FormInstanceSortField = {
    CreatedAt: 'createdAt' as FormInstanceSortField,
    SubmitDate: 'submitDate' as FormInstanceSortField,
    ApproveDate: 'approveDate' as FormInstanceSortField
};
