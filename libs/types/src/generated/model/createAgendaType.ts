...
export interface CreateAgendaType { 
    id?: any | null;
    title: string;
    description?: string;
    location?: string;
    start_time: string;
    end_time: string;
    category: CreateAgendaType.CategoryEnum;
    all_day: boolean;
    branches: Array<string>;
}
export namespace CreateAgendaType {
    export type CategoryEnum = 'birthday' | 'anniversary' | 'activity' | 'information_evening' | 'other';
    export const CategoryEnum = {
        Birthday: 'birthday' as CategoryEnum,
        Anniversary: 'anniversary' as CategoryEnum,
        Activity: 'activity' as CategoryEnum,
        InformationEvening: 'information_evening' as CategoryEnum,
