...
export interface ProcessCompensationRequestType { 
    id?: any | null;
    processor_id?: any | null;
    status: ProcessCompensationRequestType.StatusEnum;
}
export namespace ProcessCompensationRequestType {
    export type StatusEnum = 'pending' | 'granted' | 'denied';
