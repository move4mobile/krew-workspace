...
export interface CreateEmployeeType { 
    id?: any | null;
    plannable: boolean;
    news_visibility: CreateEmployeeType.NewsVisibilityEnum;
    agenda_visibility: CreateEmployeeType.AgendaVisibilityEnum;
    icon: string;
    email: string;
    password: string;
    roles: Array<string>;
    ...
    marital_status: CreateEmployeeType.MaritalStatusEnum;
    ...
    manager_id?: string;
    contract_type?: CreateEmployeeType.ContractTypeEnum;
    initials?: string;
    place_of_birth?: string;
    contract_end_date?: string;
}
export namespace CreateEmployeeType {
