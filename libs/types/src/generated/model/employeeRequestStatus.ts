...
export type EmployeeRequestStatus = 'pending' | 'granted' | 'denied';

export const EmployeeRequestStatus = {
    Pending: 'pending' as EmployeeRequestStatus,
    Granted: 'granted' as EmployeeRequestStatus,
    Denied: 'denied' as EmployeeRequestStatus
};
