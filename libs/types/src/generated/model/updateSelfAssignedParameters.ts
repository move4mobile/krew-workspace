...
export interface UpdateSelfAssignedParameters { 
    status: UpdateSelfAssignedParameters.StatusEnum | null;
    data: string | null;
    metadata?: Array<string>;
}
export namespace UpdateSelfAssignedParameters {
    export type StatusEnum = 'pending' | 'submitted';
