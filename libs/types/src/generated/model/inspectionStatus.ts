...
export type InspectionStatus = 'open' | 'action_required' | 'no_action_required' | 'handled';

export const InspectionStatus = {
    Open: 'open' as InspectionStatus,
    ActionRequired: 'action_required' as InspectionStatus,
    NoActionRequired: 'no_action_required' as InspectionStatus,
    Handled: 'handled' as InspectionStatus
};
