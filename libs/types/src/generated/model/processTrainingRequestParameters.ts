...
export interface ProcessTrainingRequestParameters { 
    new_status: ProcessTrainingRequestParameters.NewStatusEnum | null;
    remarks?: string | null;
}
export namespace ProcessTrainingRequestParameters {
    export type NewStatusEnum = 'pending' | 'granted' | 'denied';
    export const NewStatusEnum = {
        Pending: 'pending' as NewStatusEnum,
        Granted: 'granted' as NewStatusEnum,
        Denied: 'denied' as NewStatusEnum
    };
}
