...
export type FormInstanceStatus = 'pending' | 'submitted' | 'approved';

export const FormInstanceStatus = {
    Pending: 'pending' as FormInstanceStatus,
    Submitted: 'submitted' as FormInstanceStatus,
    Approved: 'approved' as FormInstanceStatus
};
