...
export interface UuidInterface { 
    ...
    fieldsHex?: Array<string>;
    clockSeqHiAndReservedHex?: string;
    clockSeqLowHex?: string;
    clockSequenceHex?: string;
    dateTime?: string;
    leastSignificantBitsHex?: string;
    mostSignificantBitsHex?: string;
    nodeHex?: string;
    timeHiAndVersionHex?: string;
    timeLowHex?: string;
    timeMidHex?: string;
    timestampHex?: string;
    urn?: string;
