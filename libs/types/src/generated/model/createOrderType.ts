...
export interface CreateOrderType { 
    ...
    type: CreateOrderType.TypeEnum;
    items: Array<OrderLineType>;
    note_creator?: string;
}
export namespace CreateOrderType {
    export type TypeEnum = 'clothing' | 'pbm' | 'first_aid';
    export const TypeEnum = {
        Clothing: 'clothing' as TypeEnum,
        Pbm: 'pbm' as TypeEnum,
        FirstAid: 'first_aid' as TypeEnum
    };
}
