 ...
 */
import { UpdateOrderLineType } from './updateOrderLineType';


export interface UpdateOrderType { 
    id?: any | null;
    status: UpdateOrderType.StatusEnum;
    note: string;
    notify_employee: boolean;
    items: Array<UpdateOrderLineType>;
}
export namespace UpdateOrderType {
    export type StatusEnum = 'open' | 'ready' | 'rejected';
